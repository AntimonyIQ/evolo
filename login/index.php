                        ...
                        <?php
                            if (isset($_POST['submit'])) {
                                ...
                                if ($stmt = $con->prepare($extra)) {
                                    ...
                                    if ($stmt->num_rows > 0) {
                                        # code...
                                        $stmt->bind_result($id, $username, $email, $password, $wallet, $balance, $ref_id, $t_ref, $withdrawal);
                                        $stmt->fetch();
                                        ...
                                        echo '<span class="alert alert-danger alert-dismissible"> <strong> Unexpected Error! Try again. </strong> </span> <br />';
                                    }
                                } else {
                                    
                                    echo '<span class="alert alert-danger alert-dismissible"> <strong> Unable to connect.</strong> </span><br />';
                                }
